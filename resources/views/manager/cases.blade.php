...
<div class="col-md-12">
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <a href="{{ route('register.cases.manager')}}"  class="btn btn-success">
                                    ...
                                    <table class="table table-striped">
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="color:black; font-size:15px;">Assigned to</th>
                                       ...
                                       <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td style="color:black; font-size:15px;">{{ $case->case_status ?? 'Pending' }}</td>
                                                <td style="color:black; font-size:15px;">{{ $case->lawyer_name ?? 'No Lawyer Assigned' }}</td>
                                                <td style="font-size: 20px;">
                                                <a href="{{ route('details.cases.manager', $case->idCases) }}" class="btn btn-outline-primary btn-sm me-1" title="View">
                                                   <i class="fa fa-eye blue2_color"></i>
                                                </a>

                                                <a href="{{ route('manager.add.task.form', ['case_id' => $case->idCases]) }}"
                                                   class="btn btn-outline-success btn-sm me-1" title="Add Task">
