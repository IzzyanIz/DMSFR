...
<nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  <ul class="list-unstyled components">
                     <li>
                        <a href="{{ route('view.dashboard.manager') }}"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a>
                     </li> 
                     <li><a href="{{ route('list.cases.manager') }}"><i class="fa fa-briefcase yellow_color"></i> <span>Cases</span></a></li>
                    
                     <li><a href="{{ route('list.task.manager') }}"><i class="fa fa-tasks green_color"></i> <span>Task</span></a></li> 
                     <li><a href="{{ route('manager.profile') }}"><i class="fa fa-user blue1_color"></i> <span>Profile</span></a></li>
                     <li> 
