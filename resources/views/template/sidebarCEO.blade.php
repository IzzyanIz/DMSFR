...
<nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  <ul class="list-unstyled components">
                     <li><a href="{{ route('view.dashboard.CEO') }}"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a></li>     
                     <li><a href="{{ route('ceo.view.staff') }}"><i class="fa fa-group orange_color"></i> <span>Staff management</span></a></li>
                      <li><a href="{{ route('ceo.view.document') }}"><i class="fa fa-file yellow_color"></i> <span>Approval Request</span></a></li>                                                              
                     <li><a href="{{ route('ceo.see.profile') }}"><i class="fa fa-user blue1_color"></i> <span>Profile</span></a></li>
