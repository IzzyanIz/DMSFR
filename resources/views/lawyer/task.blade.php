                              ...
                              <div class="table_section padding_infor_info">
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-striped">
                                       ...
                                       @forelse($tasks as $task)
                                          <tr>
                                                ...
                                                <td style="font-size: 20px;">
                                                   <a href="{{ route('update.task.lawyer', $task->idTask) }}" class="btn btn-outline-warning btn-sm me-1" title="Update">
                                       ...
                                       @empty
                                          <tr>
                                                <td colspan="8" class="text-center" style="color: gray; font-size: 15px;">
                                                   No task available.
                                                </td>
                                          </tr>
                                       @endforelse
