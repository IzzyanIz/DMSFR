...
<div class="row column1">
                        <div class="col-md-6 col-lg-6">
                           <div class="full counter_section margin_bottom_30">
                             ...
                             <a href="{{ route('view.list.staff') }}" style="text-decoration: none;">
                                    <div class="counter_no">
                                       <div>
                                          <p class="head_couter" style="color:black; font-size:11;">Total Staff</p>
                        ...
                        <div class="col-md-6 col-lg-6">
                           ...
                           <a href="{{ route('document.status.hr') }}" style="text-decoration: none;">
                              <div class="counter_no">
                                 <div>
                                 <p class="head_couter" style="color:black; font-size:11;">Pending Document</p>                                    
                                 <p class="total_no">{{ $totalPending }}</p>
                                 </div>
                              </div>
                              </a>
                           </div>
