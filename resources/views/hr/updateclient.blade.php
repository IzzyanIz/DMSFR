...
<div class="col-md-12">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form action="{{ route('update.client.hr', $client->idClient) }}" method="POST" enctype="multipart/form-data">
        @csrf 
        @method('PUT')
        ...
        <div class="mb-4">
          ...
          <select class="form-control" id="nationalitySelect" name="nationality" onchange="toggleOtherNationality()">
            ...
            <option value="Bukan Warganegara" {{ $client->nationality == 'Bukan Warganegara' ? 'selected' : '' }}>Bukan Warganegara</option>
          </select>
