...
<div class="col-md-12">
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <a href="{{ route('CEO.register.cases')}}"  class="btn btn-success">
                                    ...
                                    <table class="table table-striped">
                                       ...
                                       <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <a href="{{ route('ceo.details.cases', $case->idCases) }}" class="btn btn-outline-primary btn-sm me-1" title="View">
                                                   <i class="fa fa-eye blue2_color"></i>
                                                </a>

                                                <a href="{{ route('ceo.add.task.form', ['case_id' => $case->idCases]) }}"
