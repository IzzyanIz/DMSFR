...
<div class="col-md-12">
  <div class="card">
    ...
    <form action="{{ route('ceo.edit.profile.process') }}" method="POST" enctype="multipart/form-data">
    @csrf 
       ...
       <div class="input-group">
        ...
        <div class="mb-4">
          ...
          <input type="file" class="form-control" id="face_recognition" name="face_recognition" >
        </div>
